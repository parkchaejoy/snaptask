...
<link rel="stylesheet" href="Login.css" media="screen">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-palette-1-dark-2 u-header" id="sec-3e90"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-9b3a" data-image-width="1792" data-image-height="1024">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-align-center u-container-style u-group u-opacity u-opacity-70 u-radius-50 u-shape-round u-white u-group-1">
          <div class="u-container-layout u-container-layout-1"><span class="u-icon u-icon-circle u-palette-1-base u-text-white u-icon-1"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 60 60" style=""><use xlink:href="#svg-e4da"></use></svg><svg class="u-svg-content" viewBox="0 0 60 60" x="0px" y="0px" id="svg-e4da" style="enable-background:new 0 0 60 60;"><path d="M48.014,42.889l-9.553-4.776C37.56,37.662,37,36.756,37,35.748v-3.381c0.229-0.28,0.47-0.599,0.719-0.951
	...
	C49.513,45.874,51,48.28,51,50.957V54z"></path></svg></span>
            <h3 class="u-custom-font u-heading-font u-text u-text-default u-text-1">Welcome Back</h3>
            <div class="u-form u-login-control u-form-1">
              <form action="proseslogin.php" class="u-clearfix u-form-custom-backend u-form-spacing-20 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 30px;" method="POST">
                ...
                <div class="u-align-center u-form-group u-form-submit">
                  ...
                  <input type="submit" value="masuk" class="u-form-control-hidden">
                </div>
                <input type="hidden" value="" name="recaptchaResponse">
              </form>
            </div>
            <a href="#" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-login-control u-login-forgot-password u-text-hover-palette-1-light-3 u-btn-2">Forgot password?</a>
            <a href="formregist.php" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-btn u-button-style u-login-control u-login-create-account u-text-hover-palette-1-light-3 u-btn-3">Don't have an account?</a>
          </div>
        </div>
      </div>
    </section>
